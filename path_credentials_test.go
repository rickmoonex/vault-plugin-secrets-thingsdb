...
// newAcceptanceTestEnv creates a new test environment for credentials
func newAcceptanceTestEnv() (*testEnv, error) {
	...
	return &testEnv{
		Hostname: os.Getenv(envVarThingsDBHost),
		Token: os.Getenv(envVarThingsDBToken),
		Port: os.Getenv(envVarThingsDBPort),
